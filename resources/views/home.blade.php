...
@section('content')
    <div class="container-fluid">
        {{--        <div id="titulo-pagina"><h1 class="text-center">Generador Laravel 5.8</h1></div>--}}

        <div class="card" id="card-principal">
            <div class="card-header">
                <i class="fa fa-database" aria-hidden="true"></i><span><strong>Base de datos</strong></span>
            </div>
            <div class="card-body">
                <div id="nombreBd"></div>
        ...
        <div class="card" id="card-principal">
            <div class="card-header">
                <i class="fa fa-user-circle" aria-hidden="true"></i><span><strong>Autenticación y Roles</strong></span>
            </div>
            <div class="card-body">
